...
class VideoMediaSessionCallback(
  private val onRemoteAction: ((String) -> Unit)? = null
      ...
      return MediaSession.ConnectionResult.AcceptedResultBuilder(session)
        ...
        .setAvailableSessionCommands(
          MediaSession.ConnectionResult.DEFAULT_SESSION_COMMANDS.buildUpon()
            ...
            .add(SessionCommand(ExpoVideoPlaybackService.NEXT_COMMAND, Bundle.EMPTY))
            .add(SessionCommand(ExpoVideoPlaybackService.PREVIOUS_COMMAND, Bundle.EMPTY))
            .build()
        )
        .build()
    } catch (e: Exception) {
  ...
  override fun onCustomCommand(session: MediaSession, controller: MediaSession.ControllerInfo, customCommand: SessionCommand, args: Bundle): ListenableFuture<SessionResult> {
    when (customCommand.customAction) {
      ...
      ExpoVideoPlaybackService.NEXT_COMMAND,
      ExpoVideoPlaybackService.PREVIOUS_COMMAND -> onRemoteAction?.invoke(customCommand.customAction)
    }
